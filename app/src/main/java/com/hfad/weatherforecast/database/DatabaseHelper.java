...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    private Dao<HourForecast, String> dHours;
    private Dao<CurrentForecast, String> dCurrentForecast;
    private Dao<FutureForecast, Integer> dFutureForecast;
    private Dao<Wind, String> dWind;
    public Dao<Cloud, String> dCloud;
    public Dao<Temperature, Integer> dTemperatures;
    public Dao<Astronomy, String> dAstronomy;
    public Dao<Direction, String> dDirection;
    ...
    public Dao<HourForecast, String> getHoursDao() throws SQLException {
        if (dHours == null) {
    ...
    public Dao<CurrentForecast, String> getCurrentForecastDao() throws SQLException {
    ...
    public Dao<Wind, String> getWindDao() throws SQLException {
        if (dWind == null) {
    ...
    public Dao<Astronomy, String> getAstronomyDao() throws SQLException {
        if (dAstronomy == null) {
    ...
    public Dao<Direction, String> getDirectionDao() throws SQLException {
        if (dDirection == null) {
